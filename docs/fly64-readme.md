...
These are the original Fly64 instructions retained in the Sonic fork. Relative
documentation links and recording paths below are adjusted for this layout.
For Sonic Robo Blast 2 on Windows/Linux/macOS, use the [main README](../README.md).
Fly64's native launcher targets macOS. Run one variant at a time; they share
ports and a launcher lock. Mario replay and recording files live under
`artifacts/fly64/`, separate from Sonic's records.
...
It launches the demo and saves a roughly 75-second MP4 in `artifacts/fly64/`.
...
[Display design, signal definitions, and sources](dashboard-design.md)
...
[Model details, limitations, and tests](fly64-technical-notes.md)
...
its eye-to-neuron map. See [what comes from each source](fly64-technical-notes.md#research-references).
